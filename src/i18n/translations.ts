...
const en = {
  ...
  clear: 'Clear', apply: 'Apply', newCourse: 'New', today: 'Today', relativeToday: 'today', tomorrow: 'tomorrow', previousWeek: 'Previous week',
...
const lv: typeof en = {
  ...
  clear: 'Notīrīt', apply: 'Lietot', newCourse: 'Jauns', today: 'Šodien', relativeToday: 'šodien', tomorrow: 'rīt', previousWeek: 'Iepriekšējā nedēļa',
